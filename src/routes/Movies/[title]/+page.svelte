...
<div class="carousel carousel-center bg-transparent rounded-2xl w-[80%] m-4 space-x-4 p-4 ml-[10%]">
	<div class="carousel-item"> 
{#each Trailers as Trailer}
<iframe width="460" height="255" src="https://www.youtube.com/embed/{Trailer.key}" title="YouTube Video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="rounded-2xl m-4 hover:scale-105"></iframe>
{/each}
</div>
</div>
{/if}
